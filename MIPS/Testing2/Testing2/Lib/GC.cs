...
namespace Testing2
{
    ...
    public static unsafe class GC
    {
        ...
        public static void Enable(Testing2.String caller)
        {
        ...
        /// <summary>
        /// DO NOT CALL DIRECTLY. Use Testing2.String.New
        ...
        private static void PrintCleanupData(int startNumObjs, int startNumStrings)
        {
            ...
            //BasicConsole.SetTextColour(BasicConsole.warning_colour);
            //BasicConsole.WriteLine(((Testing2.String)"Freed objects: ") + numObjsFreed);
            //BasicConsole.WriteLine(((Testing2.String)"Freed strings: ") + numStringsFreed);
            //BasicConsole.WriteLine(((Testing2.String)"Used memory  : ") + (Heap.FBlock->used * Heap.FBlock->bsize) + " / " + Heap.FBlock->size);
            //BasicConsole.DelayOutput(2);
            //BasicConsole.SetTextColour(BasicConsole.default_colour);
        }
