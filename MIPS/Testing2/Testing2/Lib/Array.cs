...
namespace Testing2
{
    ...
    public unsafe class Array : Object
    {
        ...
        /// <summary>
        /// Implicitly converts a System.Array to an Testing2.Array. The two are one and the same thing within the 
        /// kernel just Fos_System.Array allows access to actual fields.
        /// </summary>
        /// <param name="x">The System.Array to convert.</param>
        /// <returns>The Testing2.Array (a reference to the exact same object).</returns>
        [Drivers.Compiler.Attributes.NoGC]
        [Drivers.Compiler.Attributes.NoDebug]
        public static implicit operator Testing2.Array(object[] x)
        {
            return (Testing2.Array)(object)x;
        }
