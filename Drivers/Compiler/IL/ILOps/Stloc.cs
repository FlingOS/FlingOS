...
namespace Drivers.Compiler.IL.ILOps
{
    ...
    [ILOpTarget(Target = OpCodes.Stloc)]
    [ILOpTarget(Target = OpCodes.Stloc_0)]
    [ILOpTarget(Target = OpCodes.Stloc_1)]
    [ILOpTarget(Target = OpCodes.Stloc_2)]
    [ILOpTarget(Target = OpCodes.Stloc_3)]
    [ILOpTarget(Target = OpCodes.Stloc_S)]
