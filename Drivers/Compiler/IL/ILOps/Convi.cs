...
namespace Drivers.Compiler.IL.ILOps
{
    ...
    [ILOpTarget(Target = OpCodes.Conv_I)]
    [ILOpTarget(Target = OpCodes.Conv_I1)]
    [ILOpTarget(Target = OpCodes.Conv_I2)]
    [ILOpTarget(Target = OpCodes.Conv_I4)]
    [ILOpTarget(Target = OpCodes.Conv_I8)]
