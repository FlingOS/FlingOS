    ...
    public class Cgt : IL.ILOps.Cgt
    {
        ...
        public override void Convert(ILConversionState conversionState, ILOp theOp)
        {
            ...
            else if(itemA.sizeOnStackInBytes == 4 && itemB.sizeOnStackInBytes == 4)
            {
                ...
                conversionState.Append(new ASMOps.Jmp() { JumpType = ASMOps.JmpOp.JumpLessThanEqual, DestILPosition = currOpPosition, Extension = "Else", UnsignedTest = unsignedComparison });
            ...
            else if (itemA.sizeOnStackInBytes == 8 && itemB.sizeOnStackInBytes == 8)
            {
                ...
                conversionState.Append(new ASMOps.Jmp() { JumpType = ASMOps.JmpOp.JumpGreaterThan, DestILPosition = currOpPosition, Extension = "True", UnsignedTest = unsignedComparison });
                //A high bytes < B high bytes? Jump to else case.
                conversionState.Append(new ASMOps.Jmp() { JumpType = ASMOps.JmpOp.JumpLessThan, DestILPosition = currOpPosition, Extension = "Else", UnsignedTest = unsignedComparison });
