...
namespace Drivers.Framework.Collections
{
    ...
    /// </para>
    /// </remarks>
    public class PriorityQueue : Framework.Object
    {
        ...
        public bool Insert(Comparable X)
        {
            ...
            ImplicitHeap.Add((Framework.Object)X);
            DecreaseKey(X, X.Key);
            return true;
        }
        public Comparable ExtractMin()
        {
            ...
            if (ImplicitHeap.Count > 0)
            {
                ...
                if (ImplicitHeap.Count > 1)
                {
                    ...
                    Y.Position = 1;
                    ImplicitHeap[0] = (Framework.Object)Y;
        ...
        public void Delete(Comparable X)
        {
            ...
            if (ImplicitHeap.Count > 1)
            {
                ...
                if (X != Y)
                {
                    ...
                    ImplicitHeap[Y.Position - 1] = (Framework.Object)Y;
        ...
        public Framework.String ToString()
        {
            ...
            for (int i = 0; i < ImplicitHeap.Count; i++)
            {
                result += ((Framework.String)((Comparable)ImplicitHeap[i]).Key).PadRight(20, ' ');
            }
        ...
        private void Swap(Comparable X, Comparable Y, bool print = false)
        {
            ...
            ImplicitHeap[X.Position - 1] = (Framework.Object)X;
            ImplicitHeap[Y.Position - 1] = (Framework.Object)Y;
        }
