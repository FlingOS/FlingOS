...
namespace Drivers.Framework.Collections
{
    ...
    /// </remarks>
    public class List : Framework.Object
    {
        ...
        /// </remarks>
        protected Framework.Object[] _array;
        /// <summary>
        ...
        public List(int capacity, int expandAmount)
        {
            ...
            _array = new Framework.Object[capacity];
        ...
        [Drivers.Compiler.Attributes.NoDebug]
        public void Add(Framework.Object obj)
        {
        ...
        [Drivers.Compiler.Attributes.NoDebug]
        public void Remove(Framework.Object obj)
        {
        ...
        [Drivers.Compiler.Attributes.NoDebug]
        public int IndexOf(Framework.Object obj)
        {
        ...
        private void ExpandCapacity(int amount)
        {
            ...
            Framework.Object[] newArray = new Framework.Object[_array.Length + amount];
        ...
        /// <exception cref="Drivers.Framework.Exceptions.IndexOutOfRangeException">
        /// Throws IndexOutOfRangeException if "index" is &lt; 0 or greater than the length of the list.
        /// </exception>
        public Framework.Object this[int index]
        {
            [Drivers.Compiler.Attributes.NoDebug]
            get
            {
