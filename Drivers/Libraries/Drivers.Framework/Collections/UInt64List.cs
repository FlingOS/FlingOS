...
namespace Drivers.Framework.Collections
{
    ...
    /// </summary>
    public class UInt64List : Object
    {
        /// <summary>
        ...
        public bool ContainsItemInRange(ulong start, ulong end)
        {
            for (int i = 0; i < nextIndex; i++)
            {
                ulong elem = _array[i];
        ...
        {
            ulong[] newArray = new ulong[_array.Length + amount];
