...
namespace Drivers
{
    ...
    public delegate void SecondaryOutputHandler(Framework.String str);
    ...
    public static unsafe class BasicConsole
    {
        ...
        [Drivers.Compiler.Attributes.NoDebug]
        [Drivers.Compiler.Attributes.NoGC]
        public static unsafe void Write(Framework.String str)
        {
            if (!Initialised) return;
        ...
        [Drivers.Compiler.Attributes.NoDebug]
        [Drivers.Compiler.Attributes.NoGC]
        public static unsafe void WriteLine(Framework.String str)
        {
            if (!Initialised) return;
            if (str == null)
            {
        ...
        public static unsafe void PrintTestString()
        {
            ...
            Framework.String str = "1234567890!\"£$%^&*()qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM[];'#,./{}:@~<>?\\|`¬¦";
            int strLength = str.length;
            char* strPtr = str.GetCharPointer();
            char* vidMemPtr = vidMemBasePtr;
            while (strLength > 0)
