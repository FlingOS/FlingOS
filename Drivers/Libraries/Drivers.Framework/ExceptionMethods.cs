...
namespace Drivers
{
    ...
    public static unsafe class ExceptionMethods
    {
        ...
        /// an immediate halt.
        /// </summary>
        public static Framework.String HaltReason = "";
        ...
        public static Framework.Exception CurrentException
        {
            [Drivers.Compiler.Attributes.NoGC]
            [Drivers.Compiler.Attributes.NoDebug]
            get
            {
                ...
                {
                    return (Framework.Exception)Utilities.ObjectUtilities.GetObject(State->CurrentHandlerPtr->Ex);
                }
                return null;
            }
        }
        ...
        [Drivers.Compiler.Attributes.NoDebug]
        [Drivers.Compiler.Attributes.NoGC]
        public static unsafe void Throw(Framework.Exception ex)
        {
            Drivers.Framework.GC.IncrementRefCount(ex);
            ...
            if (State->CurrentHandlerPtr->Ex != null)
            {
                ...
                ex.InnerException = (Drivers.Framework.Exception)Utilities.ObjectUtilities.GetObject(State->CurrentHandlerPtr->Ex);
            }
        ...
        {
            Framework.Exception ex = (Framework.Exception)Utilities.ObjectUtilities.GetObject(exPtr);
            ex.InstructionAddress = *((uint*)BasePointer + 1);
            Throw(ex);
        }
        ...
        public static unsafe void HandleLeave(void* continuePtr)
        {
            ...
            if ((uint)State->CurrentHandlerPtr->FilterAddress != 0x0u)
            {
                ...
                if (State->CurrentHandlerPtr->Ex != null)
                {
                    Framework.GC.DecrementRefCount((Framework.Object)Utilities.ObjectUtilities.GetObject(State->CurrentHandlerPtr->Ex));
        ...
        public static void Throw_DivideByZeroException()
        {
            ...
            BasicConsole.WriteLine(HaltReason);
            BasicConsole.SetTextColour(BasicConsole.default_colour);
            Throw(new Framework.Exceptions.DivideByZeroException());
        }
        /// <summary>
        ...
        public static void Throw_DivideByZeroException(uint address)
        {
            ...
            BasicConsole.WriteLine(HaltReason);
            BasicConsole.SetTextColour(BasicConsole.default_colour);
            Throw(new Framework.Exceptions.DivideByZeroException(address));
        }
        /// <summary>
        ...
        public static void Throw_OverflowException()
        {
            ...
            BasicConsole.WriteLine(HaltReason);
            BasicConsole.SetTextColour(BasicConsole.default_colour);
            Throw(new Framework.Exceptions.OverflowException("Processor reported an overflow."));
        }
        /// <summary>
        ...
        public static void Throw_InvalidOpCodeException()
        {
            ...
            BasicConsole.WriteLine(HaltReason);
            BasicConsole.SetTextColour(BasicConsole.default_colour);
            Throw(new Framework.Exceptions.InvalidOpCodeException());
        }
        /// <summary>
        ...
        public static void Throw_DoubleFaultException(uint address, uint errorCode)
        {
            ...
            BasicConsole.WriteLine(HaltReason);
            BasicConsole.SetTextColour(BasicConsole.default_colour);
            Throw(new Framework.Exceptions.DoubleFaultException(errorCode));
        }
        /// <summary>
        ...
        public static void Throw_StackException()
        {
            ...
            BasicConsole.WriteLine(HaltReason);
            BasicConsole.SetTextColour(BasicConsole.default_colour);
            Throw(new Framework.Exceptions.StackException());
        }
        /// <summary>
        ...
        public static void Throw_PageFaultException(uint eip, uint errorCode, uint address)
        {
            ...
            else
            {
                ...
                Throw(new Framework.Exceptions.PageFaultException(errorCode, address));
            }
        }
        ...
        public static void Throw_NullReferenceException(uint address)
        {
            ...
            Framework.Exception ex = new Framework.Exceptions.NullReferenceException();
        ...
        public static void Throw_ArrayTypeMismatchException()
        {
            ...
            Throw(new Framework.Exceptions.ArrayTypeMismatchException());
        }
        /// <summary>
        ...
        public static void Throw_IndexOutOfRangeException()
        {
            ...
            Framework.Exception ex = new Framework.Exceptions.IndexOutOfRangeException(0, 0);
            ex.InstructionAddress = *((uint*)BasePointer + 1);
            Throw(ex);
        }
        ...
        public static void PrintStackTrace()
        {
            ...
            {
                Framework.String msg = "EBP: 0x        , Return Address: 0x        , Prev EBP: 0x        ";
                //EBP: 14
                //Return address: 42
                //Prev EBP: 64
        ...
        [Drivers.Compiler.Attributes.NoDebug]
        [Drivers.Compiler.Attributes.NoGC]
        public static void FillString(uint value, int offset, Framework.String str)
        {
            int end = offset - 8;
            while (offset > end)
            {
