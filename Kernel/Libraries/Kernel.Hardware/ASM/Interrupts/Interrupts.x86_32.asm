...
GLOBAL method_System_Void_RETEND_Kernel_Hardware_Interrupts_Interrupts_DECLEND_EnableInterrupts_NAMEEND___:function
GLOBAL method_System_Void_RETEND_Kernel_Hardware_Interrupts_Interrupts_DECLEND_DisableInterrupts_NAMEEND___:function
GLOBAL method_Kernel_Hardware_Interrupts_InterruptDescriptor__RETEND_Kernel_Hardware_Interrupts_Interrupts_DECLEND_GetIDTPtr_NAMEEND___:function
