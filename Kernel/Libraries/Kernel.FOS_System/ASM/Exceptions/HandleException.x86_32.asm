...
GLOBAL method_System_Void_RETEND_Kernel_ExceptionMethods_DECLEND_HandleException_NAMEEND__:function
...
EXTERN staticfield_System_String_Kernel_ExceptionMethods_UnhandledException_PanicMessage
...
method_System_Void_RETEND_Kernel_ExceptionMethods_DECLEND_HandleException_NAMEEND__:
...
cmp eax, 0
jz method_System_Void_RETEND_Kernel_ExceptionMethods_DECLEND_HandleException_NAMEEND__.NotInHandler
mov dword eax, [staticfield_Kernel_ExceptionHandlerInfo__Kernel_ExceptionMethods_CurrentHandlerPtr]
mov dword eax, [eax+16]
mov dword [staticfield_Kernel_ExceptionHandlerInfo__Kernel_ExceptionMethods_CurrentHandlerPtr], eax
method_System_Void_RETEND_Kernel_ExceptionMethods_DECLEND_HandleException_NAMEEND__.NotInHandler:
...
mov dword ebx, [eax+8]
cmp ebx, 0
jz method_System_Void_RETEND_Kernel_ExceptionMethods_DECLEND_HandleException_NAMEEND__UnhandledException
...
jz method_System_Void_RETEND_Kernel_ExceptionMethods_DECLEND_HandleException_NAMEEND__Step5

; If we get here, this is a catch handler
; So set PendingException to false (0)
mov dword [staticfield_System_Boolean_Kernel_ExceptionMethods_PendingException], 0


; 5. Return control to handler
method_System_Void_RETEND_Kernel_ExceptionMethods_DECLEND_HandleException_NAMEEND__Step5:
...
method_System_Void_RETEND_Kernel_ExceptionMethods_DECLEND_HandleException_NAMEEND__UnhandledException:
; If we have an unhandled exception, we show an error message and then panic!

mov dword eax, [staticfield_System_String_Kernel_ExceptionMethods_UnhandledException_PanicMessage]
push eax
