method_System_Void_RETEND_Kernel_Exceptions_DECLEND_Throw_NAMEEND__Kernel_FOS_System_Exception_:
method_System_Void_RETEND_Kernel_Exceptions_DECLEND_ThrowFromPtr_NAMEEND__System_UInt32__:
...
cmp eax, 0
jz method_System_Void_RETEND_Kernel_Exceptions_DECLEND_Throw_NAMEEND__Kernel_FOS_System_Exception_.NoCurrentException
...
method_System_Void_RETEND_Kernel_Exceptions_DECLEND_Throw_NAMEEND__Kernel_FOS_System_Exception_.NoCurrentException:


; 1. Set Current Exception to that specified by arg to this method
mov dword eax, [esp+4]
mov dword [staticfield_Kernel_FOS_System_Exception_Kernel_Exceptions_CurrentException], eax


; 2. Set Pending Exception to true
mov dword [staticfield_System_Boolean_Kernel_Exceptions_PendingException], 1
...
mov dword eax, [staticfield_System_String_Kernel_Exceptions_Throw_PanicMessage]
push eax
