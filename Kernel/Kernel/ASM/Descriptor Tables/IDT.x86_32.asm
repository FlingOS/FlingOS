...
Interrupt0Handler:
call method_System_Void_RETEND_Kernel_Exceptions_DECLEND_Throw_DivideByZeroException_NAMEEND___

Interrupt4Handler:
call method_System_Void_RETEND_Kernel_Exceptions_DECLEND_Throw_OverflowException_NAMEEND___
 
Interrupt6Handler:
call method_System_Void_RETEND_Kernel_Exceptions_DECLEND_Throw_OverflowException_NAMEEND___

Interrupt8Handler:
call method_System_Void_RETEND_Kernel_Exceptions_DECLEND_Throw_DoubleFaultException_NAMEEND___
