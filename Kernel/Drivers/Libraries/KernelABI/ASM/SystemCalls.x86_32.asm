...
GLOBAL method_System_UInt32_RETEND_KernelABI_SystemCalls_DECLEND_Call_NAMEEND__KernelABI_SystemCalls_Calls_System_UInt32_System_UInt32_System_UInt32_:function
