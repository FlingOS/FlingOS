...
namespace Drivers.Compiler
{
    ...
    public static class Errors
    {
        ...
        /// <summary>
        /// Error code for the user specifying a path to a library file which doesn't exist meaning the loader couldn't load the IL library to compile.
        /// </summary>
        ...
        /// <summary>
        /// Error code for an external process reporting an error to the Utilities (which are used to start/manage external processes).
        /// </summary>
