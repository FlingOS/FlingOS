...
namespace Kernel.Compiler
{
    ...
    public class ILScannerState
    {
        ...
        public void AddType(DB_Type TheDBType)
        {
            ...
            TypesTableDataBlock.ASM.AppendLine(string.Format("{0}: dd {1}, {2}, {3}, {4} \t\t; {5}", 
                TypeId, SizeVal, IdVal, StackSizeVal, IsValueTypeVal, TheDBType.Signature));
        }
